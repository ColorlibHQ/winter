<?php
    $shipping_section  = winter_get_page_section_visibility_option( 'shipping_section' );
    $instagram_section = winter_get_page_section_visibility_option( 'instagram_section' );
    
    if ( $shipping_section == 1 ) {
        ?>
        <!-- free shipping here -->
