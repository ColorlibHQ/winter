...
class winter_Enqueue {

	public $scripts = array();

	public function winter_scripts_enqueue_init() {
		add_action( 'wp_enqueue_scripts', array( $this, 'winter_frontend_enqueue_scripts' ) );
	}

	public function winter_frontend_enqueue_scripts() {
