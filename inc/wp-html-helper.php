...
// image default alt
if ( ! function_exists( 'winter_img_default_alt' ) ) {
	function winter_img_default_alt( $url = '' ) {
...
// Image Tag
if ( ! function_exists( 'winter_img_tag' ) ) {
	function winter_img_tag( array $args ) {
		...
		if ( ! empty( $args['alt'] ) ) {
			...
			$alt = winter_img_default_alt( $url );
		}
...
// Anchor Tag
if ( ! function_exists( 'winter_anchor_tag' ) ) {
	function winter_anchor_tag( array $args ) {
...
// Heading Tag
if ( ! function_exists( 'winter_heading_tag' ) ) {
	function winter_heading_tag( array $args ) {
...
// Paragraph Tag
if ( ! function_exists( 'winter_paragraph_tag' ) ) {
	function winter_paragraph_tag( array $args ) {
...
// Other Tag
if ( ! function_exists( 'winter_other_tag' ) ) {
	function winter_other_tag( array $args ) {
...
// Button Element
if ( ! function_exists( 'winter_button_element ' ) ) {
	function winter_button_element( array $args ) {
