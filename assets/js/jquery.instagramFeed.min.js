                ...
                if (b.get_raw_json) b.callback(JSON.stringify({
                    ...
                    if (b.display_gallery)
                        if (a.is_private) c += "<p class='instagram_private'><strong>This profile is private</strong></p>";
                            ...
                            for (d = 0; d < max; d++) c += "<div class='single_instgram_photo'>", c += "\t<img src='" +
                                a[d].node.thumbnail_src + "' alt='" + b.username + " instagram image " + d + "'" + k + " /><a href='https://www.instagram.com/p/" + a[d].node.shortcode + "' target='_blank'><i class='ti-instagram'></i></a>", c += "</div></div></a>";
