(function ($) {
  ...
  if ($('.winter-wc-pagination').length > 0) {
    $('.winter-wc-pagination .next.page-numbers').addClass('btn_2');
  }

  
  // WC price filter form submit on change the slider
  // $('.price_slider').slider();
  // $( ".price_slider" ).on( "slidechange", function( event, ui ) {
  //   console.log('Your new value: ' + ui.value);
    
  //   $(".price_slider_amount button").submit();
  // } );
